...
// gcc -o sort_reverse sort_reverse.c
// gcc -o reverse reverse.c
// ./sort_reverse 10 5 3 8 7

// reverse.c (Reverse Program)
// c
// Copy code
// #include <stdio.h>
// #include <stdlib.h>
...
// int main(int argc, char *argv[]) {
//     if (argc < 2) {
//         printf("Usage: reverse <array elements>\n");
//         return 1;
//     }
...
// sort_reverse.c (for the main program)
// reverse.c (for the reverse program)
